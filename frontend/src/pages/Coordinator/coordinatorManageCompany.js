            ...
            >
                ...
                <Tab className="CompanyTab mt-5" eventKey="CompanyVisit" title="Company Visit">
                    ...
                    <div className=''>
                        ...
                        <Row className='justify-content-between mb-5'>
                            <Col lg={8}>
                                <h3 className='mt-2'>Scheduled Company Visits</h3>
                            </Col>
                            <Col>
                                <Nav.Link as={Link} to="/Coordinator/Schedule-Company-Visit"><Button className='ml-5'><i class="bi bi-plus-circle mr-2"></i>Schedule Company Visist</Button></Nav.Link>
                            </Col>
                        </Row>
                        {/* </div> */}
