...
return (
  ...
  <Container className='mt-5'>
      ...
      <h3>Announcements</h3>
        ...
        <AnnouncementCard Header='Posted at: 3.00 pm | 01.08.2022' Title='Progress Report Submission are due on 30th of August' Text='lease note that there will be lectures and other academic activities on August 8 (Monday) and August 9 (Tuesday), despite that week has been declared as the mid semester break in the academic calendar. This is to compensate for the two Mondays that we missed at the beginning of the semester.' location='Company/AnnouncementPage'></AnnouncementCard>
